  ...
  <div class="min-h-screen mb-24">
    <div class="upper-part h-96 sm:h-[586px] min-w-screen gradient-bg flex flex-col justify-center items-center">
      ...
      <div class="search-center-box mt-4 flex">
        <input type="text" class="search-bar sm:w-[600px] bg-white h-14 rounded-s-3xl pl-4 pr-4 focus:outline-none" placeholder="Search restaurant here" v-model="search" />
